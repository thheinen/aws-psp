...
property :spot_fleet_request_config_data, Hash,
         ...
         callbacks: {
           ...
           "Subproperty `AllocationStrategy`is not one of `capacityOptimized`, `capacityOptimizedPrioritized`, `diversified`, `lowestPrice`" => lambda { |v| %w{capacityOptimized capacityOptimizedPrioritized diversified lowestPrice}.include? v[:AllocationStrategy] },
