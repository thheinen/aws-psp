...
property :as2_config, Hash,
         callbacks: {
           ...
           "Subproperty `EncryptionAlgorithm`is not one of `AES128_CBC`, `AES192_CBC`, `AES256_CBC`, `NONE`" => lambda { |v| %w{AES128_CBC AES192_CBC AES256_CBC NONE}.include? v[:EncryptionAlgorithm] },
