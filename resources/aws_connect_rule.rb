...
property :trigger_event_source, Hash,
         ...
         callbacks: {
           ...
           "Subproperty `EventSourceName`is not one of `OnPostCallAnalysisAvailable`, `OnRealTimeCallAnalysisAvailable`, `OnPostChatAnalysisAvailable`, `OnZendeskTicketCreate`, `OnZendeskTicketStatusUpdate`, `OnSalesforceCaseCreate`" => lambda { |v| %w{OnPostCallAnalysisAvailable OnRealTimeCallAnalysisAvailable OnPostChatAnalysisAvailable OnZendeskTicketCreate OnZendeskTicketStatusUpdate OnSalesforceCaseCreate}.include? v[:EventSourceName] },
