...
resource_name :aws_cloud_front_cloud_front_origin_access_identity
provides :aws_cloud_front_cloud_front_origin_access_identity, target_mode: true, platform: "aws"
...
property :cloud_front_origin_access_identity_config, Hash,
         required: true,
         callbacks: {
