...
resource_name :aws_route53_resolver_resolver_query_logging_config
provides :aws_route53_resolver_resolver_query_logging_config, target_mode: true, platform: "aws"
