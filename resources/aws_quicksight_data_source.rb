...
property :type, Hash,
         callbacks: {
           ...
           "typeis not one of `ADOBE_ANALYTICS`, `AMAZON_ELASTICSEARCH`, `AMAZON_OPENSEARCH`, `ATHENA`, `AURORA`, `AURORA_POSTGRESQL`, `AWS_IOT_ANALYTICS`, `DATABRICKS`, `GITHUB`, `JIRA`, `MARIADB`, `MYSQL`, `ORACLE`, `POSTGRESQL`, `PRESTO`, `REDSHIFT`, `S3`, `SALESFORCE`, `SERVICENOW`, `SNOWFLAKE`, `SPARK`, `SQLSERVER`, `TERADATA`, `TWITTER`, `TIMESTREAM`" => lambda { |v| %w{ADOBE_ANALYTICS AMAZON_ELASTICSEARCH AMAZON_OPENSEARCH ATHENA AURORA AURORA_POSTGRESQL AWS_IOT_ANALYTICS DATABRICKS GITHUB JIRA MARIADB MYSQL ORACLE POSTGRESQL PRESTO REDSHIFT S3 SALESFORCE SERVICENOW SNOWFLAKE SPARK SQLSERVER TERADATA TWITTER TIMESTREAM}.include? v },
         },
         description: ""
