...
resource_name :aws_sagemaker_model_explainability_job_definition
provides :aws_sagemaker_model_explainability_job_definition, target_mode: true, platform: "aws"
...
property :model_explainability_app_specification, Hash,
         required: true,
         callbacks: {
...
property :model_explainability_baseline_config, Hash,
         description: ""

property :model_explainability_job_input, Hash,
         required: true,
         description: ""

property :model_explainability_job_output_config, Hash,
         required: true,
         callbacks: {
...
rest_api_collection "/AWS::SageMaker::ModelExplainabilityJobDefinition"
rest_api_document "/AWS::SageMaker::ModelExplainabilityJobDefinition"
...
rest_post_only_properties %i{
  endpoint_name job_definition_name job_resources model_explainability_app_specification model_explainability_baseline_config model_explainability_job_input model_explainability_job_output_config network_config role_arn stopping_condition tags
}
